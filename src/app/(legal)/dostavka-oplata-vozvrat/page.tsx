    ...
    },
    {
      ...
      content: (
        <>
          ...
          <p className="text-[var(--color-gray)] mb-4">
            Заказы отправляются после подписания договора и предоплаты в размере 50%. Это позволяет нам гарантировать начало производства и обеспечить высокое качество продукции.
          </p>
