        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="rounded-2xl overflow-hidden relative h-[400px] mb-16 ">
            <div className="absolute inset-0 flex items-center justify-center">
              <h1 className="text-5xl font-bold text-[var(--color-white)] text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="md:col-span-2 space-y-6">
              <h2 className="text-3xl font-semibold text-[var(--color-white)]">
                Наша миссия
              </h2>
          ...
          <div className="mt-16 space-y-8">
            <h2 className="text-3xl font-semibold text-center text-[var(--color-white)]">
              Наши ценности
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="p-6 bg-dark rounded-lg text-center">
                ...
                <h3 className="text-lg font-semibold text-[var(--color-white)]">Экологичность</h3>
              ...
              <div className="p-6 bg-dark rounded-lg text-center">
                ...
                <h3 className="text-lg font-semibold text-[var(--color-white)]">Качество</h3>
              ...
              <div className="p-6 bg-dark rounded-lg text-center">
                ...
                <h3 className="text-lg font-semibold text-[var(--color-white)]">Клиентоориентированность</h3>
              ...
              <div className="p-6 bg-dark rounded-lg text-center">
                ...
                <h3 className="text-lg font-semibold text-[var(--color-white)]">Инновации</h3>
