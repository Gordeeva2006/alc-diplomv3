            ...
            <div className="space-y-8 w-full">
              ...
              <section className="bg-dark rounded-xl p-8 shadow-xl">
                <div className="flex items-center mb-6">
                  ...
                  <h2 className="text-2xl font-semibold text-white">Реквизиты компании</h2>
                </div>

                <div className="space-y-4 pl-14 text-[var(--color-gray)]">
                  <div className="pb-4 border-b border-[var(--color-gray)]/50">
                    <p className="font-medium text-white mb-1">Полное наименование</p>
                    <p className="white">ООО "XXXXXXXXXX"</p>
                  </div>

                  <div className="pb-4 border-b border-[var(--color-gray)]/50">
                    <p className="font-medium text-white mb-1">Юридический адрес</p>
                    <p>XXXXX, X, ул. XXXXXXXXXXX, д. XX, помещ. XX/X/X</p>
                  </div>

                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <p className="font-medium text-white mb-1">ИНН</p>
                      <p>X0XXXXXXXX</p>
                    </div>
                    <div>
                      <p className="font-medium text-white mb-1">КПП</p>
                      <p>XXXXXXX01</p>
                    </div>
                    <div>
                      <p className="font-medium text-white mb-1">ОГРН</p>
                      <p>X247700550822</p>
                    </div>
                  </div>
                </div>
              ...
              <section className="bg-dark rounded-xl p-8 shadow-xl">
                <div className="flex items-center mb-6">
                  ...
                  <h2 className="text-2xl font-semibold text-white">Банковские реквизиты</h2>
                </div>

                <div className="space-y-4 pl-14 text-[var(--color-gray)]">
                  <div className="pb-4 border-b border-[var(--color-gray)]/50">
                    <p className="font-medium text-white mb-1">Банк</p>
                    <p>АО «XXXXXX»</p>
                  </div>

                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <p className="font-medium text-white mb-1">БИК</p>
                      <p>XXXXXXX74</p>
                    </div>
                    <div>
                      <p className="font-medium text-white mb-1">ИНН банка</p>
                      <p>XXXXXXX679</p>
                    </div>
                    <div>
                      <p className="font-medium text-white mb-1">Корреспондентский счёт</p>
                      <p>301018XXXXXX50000974</p>
                    </div>
                    <div>
                      <p className="font-medium text-white mb-1">Расчётный счёт</p>
                      <p>407028XXXXXXXXXX9725</p>
                    </div>
                  </div>

                  <div>
                    <p className="font-medium text-white mb-1">Адрес банка</p>
